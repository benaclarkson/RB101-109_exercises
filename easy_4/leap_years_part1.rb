...
# input: year
# output: truthiness of return value
# rules:
#   - leap year: year % 4 == 0 unless year % 100 == 0
#   - not leap year: year % 100 == 0 unless year % 400 == 0
#   - can assume above is a rule for any year greater than 0
